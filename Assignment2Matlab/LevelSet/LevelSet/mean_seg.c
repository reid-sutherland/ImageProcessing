...
the classical Chan-Vese data term which measures the conformity of image
data within each region to the piecewise constant model. 
*******************************************************************/
...
int Update_Mean(List_LevelSet *p_lls, Image *p_image,
		   int p){
